...
def validate_lxc_id(lxc_id):
    ...
    try:
        ...
        raise ValidationError(f"Invalid container ID format: {lxc_id}") from e
...
def validate_cores(cores):
    ...
    try:
        ...
        raise ValidationError(f"Invalid cores format: {cores}") from e
...
def validate_memory(memory):
    ...
    try:
        ...
        raise ValidationError(f"Invalid memory format: {memory}") from e
...
def validate_disk_size(disk_size):
    ...
    try:
        ...
        raise ValidationError(f"Invalid disk size format: {disk_size}") from e
