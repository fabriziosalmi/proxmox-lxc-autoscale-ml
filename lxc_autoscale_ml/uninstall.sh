...
log "INFO" "Starting LXC AutoScale ML uninstallation..."
...
remove_files "/usr/local/bin/lxc_autoscale_ml" "/etc/systemd/system/lxc_autoscale_ml.service" "/etc/lxc_autoscale/lxc_autoscale_ml.yaml"
